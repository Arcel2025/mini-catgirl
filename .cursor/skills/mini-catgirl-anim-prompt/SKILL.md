...
小委屈先补：湿毛巾擦拭（护项圈）、拖动静帧、逗一逗享受、赶走时的求情和难过离去。默认动感静帧，网页平移。不要摔趴。求情不要复用作揖求饭。离去不要画出门街景。

物种通用以后才是：箱里坐、一件玩具、舔嘴唇。吃的两帧咀嚼、走的中间帧，有空再补。

先不要做：茶几底钻、喝水条、厕所洗澡涂泡泡、出门街景、关禁闭。关禁闭等更多房间再做，不另出贴纸。新房间空景按餐厅 `dining.png`：45 度斜俯视，场地填满，不要 90 度顶视。卫生间锁洗手台 `bathroom.png`，不要浴缸。卧室锁 `bed.png`，从床尾看。
